...
(function () {
  const DICT = {
    fr: {
      ...
      "man.body": "Votre cuisine est excellente. Votre salle est pleine. <em>Et pourtant</em>, dehors, vous êtes invisible : un Instagram qui dort, des messages jamais lus, des avis qui vous échappent. Pendant ce temps, à quelques rues de là, un concurrent moins bon que vous remplit sa salle avec un seul reel bien senti.",
      ...
      "pil.2.t": "Scripts & captation", "pil.2.d": "Avant chaque tournage, un script précis : plan par plan, ce qu'il faut dire, ce qu'il faut capter. Vous filmez avec votre téléphone, guidé du début à la fin.",
      "pil.3.t": "Création de contenu & visuels", "pil.3.d": "Montage de vos formats courts, visuels, carrousels. On façonne le contenu à partir de votre matière et de vos temps forts.",
      "pil.4.t": "Copywriting", "pil.4.d": "Légendes, bio, fiche Google, descriptions de menu : on retravaille tous vos textes pour qu'ils donnent envie, pas juste qu'ils informent.",
      "pil.5.t": "Test audience IA", "pil.5.d": "Avant de trancher entre deux visuels ou deux angles, on simule la réaction d'une audience cible par IA. On publie ce qui marche, pas ce qu'on préfère.",
      "pil.6.t": "Publication", "pil.6.d": "Calendrier éditorial tenu, légendes écrites, formats adaptés à chaque réseau. Rien ne dort.",
      "pil.7.t": "Community management", "pil.7.d": "Réponses aux messages et commentaires, dans le ton de votre maison. Une présence vivante au quotidien.",
      "pil.8.t": "Google & avis", "pil.8.d": "Fiche optimisée, photos soignées, gestion des avis. La première impression se joue avant la porte.",
      "pil.9.t": "Croissance", "pil.9.d": "Pilotage de la pub Meta & TikTok, événementiel, seeding créateurs. On fait venir du monde.",
      ...
      "tour.1.b1": "Script envoyé avant le service : quoi filmer, dans quel ordre",
      "tour.1.b2": "Story montée et publiée en moins de 10 minutes",
      "tour.1.b3": "Légende et hashtags écrits à l'avance, prêts à partir",
      "tour.2.line": "23h50. Le shaker claque, les néons vibrent — le reel de la signature tourne déjà.",
      "tour.2.b1": "Plan de tournage du reel signature préparé en amont",
      "tour.2.b2": "Montage rythmé et sous-titré, livré sous 48h",
      "tour.2.b3": "Publication calée sur l'heure de plus forte audience",
      "tour.3.line": "2h10. La basse fait trembler le plafond — demain, la file d'attente aura vu la vidéo.",
      "tour.3.b1": "Capture guidée pendant la soirée, script remis à l'équipe",
      "tour.3.b2": "Teaser monté et publié dès le lendemain matin",
      "tour.3.b3": "Ciblage publicitaire géolocalisé pour la semaine suivante",
      "tour.4.line": "8h05. Latte art, lumière douce — le quartier sait déjà où prendre son premier café.",
      "tour.4.b1": "Photo et carrousel préparés à partir des visuels du matin",
      "tour.4.b2": "Story quotidienne postée avant l'heure de pointe",
      "tour.4.b3": "Réponses aux commentaires et avis dans l'heure",
    ...
    en: {
      ...
      "man.body": "Your food is excellent. Your room is full. <em>And yet</em>, outside, you're invisible: an Instagram that's asleep, messages never read, reviews slipping away. Meanwhile, a few streets away, a competitor who's not as good as you is filling their room with a single well-made reel.",
      ...
      "pil.2.t": "Scripts & capture", "pil.2.d": "Before every shoot, a precise script: shot by shot, what to say, what to capture. You film on your phone, guided from start to finish.",
      "pil.3.t": "Content creation & visuals", "pil.3.d": "Editing your short-form, visuals, carousels. We shape content from your material and your highlights.",
      "pil.4.t": "Copywriting", "pil.4.d": "Captions, bio, Google listing, menu descriptions: we rework every piece of text so it makes people want in, not just informs them.",
      "pil.5.t": "AI audience testing", "pil.5.d": "Before choosing between two visuals or two angles, we simulate a target audience's reaction with AI. We publish what works, not what we prefer.",
      "pil.6.t": "Publishing", "pil.6.d": "A real editorial calendar, written captions, formats tuned to each platform. Nothing sleeps.",
      "pil.7.t": "Community management", "pil.7.d": "Replies to messages and comments, in your house's voice. A presence that stays alive.",
      "pil.8.t": "Google & reviews", "pil.8.d": "Optimised listing, polished photos, review handling. First impressions happen before the door.",
      "pil.9.t": "Growth", "pil.9.d": "Meta & TikTok ad management, events, creator seeding. We bring people in.",
      ...
      "tour.1.b1": "Script sent before service: what to film, in what order",
      "tour.1.b2": "Story edited and posted in under 10 minutes",
      "tour.1.b3": "Caption and hashtags written in advance, ready to go",
      "tour.2.line": "11:50pm. The shaker snaps, the neons hum — the signature's reel is already out.",
      "tour.2.b1": "Signature reel shot list prepared ahead of time",
      "tour.2.b2": "Punchy, subtitled edit delivered within 48h",
      "tour.2.b3": "Publishing timed to peak audience hours",
      "tour.3.line": "2:10am. Bass in the ceiling — tomorrow, the queue will have seen the video.",
      "tour.3.b1": "Guided capture during the night, script handed to the team",
      "tour.3.b2": "Teaser edited and published the next morning",
      "tour.3.b3": "Geo-targeted ads for the following week",
      "tour.4.line": "8:05am. Latte art, soft light — the neighbourhood already knows where its first coffee is.",
      "tour.4.b1": "Photo and carousel built from the morning's visuals",
      "tour.4.b2": "Daily story posted before the morning rush",
      "tour.4.b3": "Comments and reviews answered within the hour",
